        ...
        try {
            ...
            if (user) {
                ...
                if (role === ROLES.PROJECT_MANAGER) {
                    ...
                    // Finance users see ALL invoices that have been PM-approved (not just assigned)
                    // According to PRD: Finance Stage - visible AFTER PM approval
                    query.status = INVOICE_STATUS.PENDING_FINANCE_REVIEW;
