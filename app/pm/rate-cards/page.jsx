            ...
            <div className="max-w-7xl mx-auto px-4 md:px-6 space-y-6">
                ...
                <div className="bg-white/80 backdrop-blur-xl rounded-2xl border border-white/20 shadow-lg p-3 sm:p-4 mb-6">
                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-start sm:items-center justify-between">
                        ...
                        <button
                            ...
                            className="w-full sm:w-auto px-6 py-3 bg-linear-to-br from-indigo-600 to-blue-600 text-white rounded-xl font-black text-[10px] uppercase tracking-widest shadow-lg shadow-indigo-500/20 active:scale-95 transition-all flex items-center justify-center gap-2"
                        >
                ...
                {!loading && ratecards.length === 0 && (
                    <Card className="text-center py-20 flex flex-col items-center">
                        ...
                        <button
                            onClick={() => { resetForm(); setShowCreateModal(true); }}
                            className="mt-6 px-8 py-3 bg-indigo-600 text-white rounded-xl font-black text-[10px] uppercase tracking-widest shadow-lg shadow-indigo-500/20 active:scale-95 transition-all"
                        >
                            Create First Card
                        </button>
                    </Card>
                    ...
                    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-100 p-4 overflow-y-auto">
                        ...
                        >
                            <div className="flex justify-between items-start mb-10">
                                <div>
                                    <p className="text-[10px] font-black uppercase tracking-widest text-indigo-600 mb-1">Project Manager Action</p>
                            ...
                            <form onSubmit={editingCard ? handleUpdateRatecard : handleCreateRatecard} className="space-y-8">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <select
                                                ...
                                                className="w-full pl-12 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl text-slate-700 font-bold text-sm focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-hidden transition-all appearance-none disabled:bg-slate-100 disabled:cursor-not-allowed"
                                            >
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-12 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl text-slate-700 font-bold text-sm focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-hidden transition-all"
                                            />
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div key={idx} className="flex gap-3 items-center group">
                                                ...
                                                <div className="w-32 relative">
                                                    ...
                                                    <input
                                                        ...
                                                        className="w-full pl-7 pr-3 py-3 bg-white border border-slate-200 rounded-xl text-slate-700 font-bold text-xs focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-hidden transition-all"
                                                    />
                                                </div>
                                                <div className="w-32 relative">
                                                    <select
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-slate-700 font-bold text-sm focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-hidden transition-all"
                                    />
                                </div>
                                ...
                                <div className="flex gap-4 pt-4 border-t border-slate-100">
                                    ...
                                    <button
                                        type="submit"
                                        className="flex-1 px-6 py-4 bg-linear-to-br from-indigo-600 to-blue-600 text-white rounded-2xl font-black text-xs uppercase tracking-widest shadow-xl shadow-indigo-500/20 hover:shadow-indigo-500/30 transition-all active:scale-95"
                                    >
